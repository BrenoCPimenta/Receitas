...
9. Como usuário, quero criar uma conta.
      - [X] 47 Criar a tela de cadastro. (Pedro)
      - [X] 48 Criar o formulário de cadastro. (username, password, email) (Pedro)
      - [X] 49 Criar regras para validação dos campos no frontend. (Pedro)
      - [X] 50 Cria a tabela usuários no banco. (Breno)
...
10. Como usuário, quero fazer login.
      - [X] 58 Criar a tela de login. (Pedro)
      - [X] 59 Criar o formulário de login. (Pedro)
      - [X] 60 Criar endpoint para realizar o login. (Luiz)
      - [X] 61 Criar consulta para login de usuário. (Breno)
      - [X] 62 Teste de integração do endpoint de login. (Luiz)
      - [X] 63 Teste de integração com SQLite. (Breno)
      - [X] 64 Teste de integração com ElasticSearch. (Luiz)
      - [X] 65 Teste de interface de usuário: testar login com sucesso. (Rafael)
      - [X] 66 Teste de interface de usuário: teste de busca simples. (Rafael)
